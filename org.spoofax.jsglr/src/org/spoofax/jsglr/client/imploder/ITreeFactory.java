...
public interface ITreeFactory<TNode> extends ITreeInspector<TNode> {
	...
	TNode createNonTerminal(String sort, String constructor, IToken leftToken, IToken rightToken,
			List<TNode> children, boolean isCompletion, boolean isNestedCompletion);
	...
	TNode createAmb(List<TNode> alternatives, IToken leftToken, IToken rightToken, boolean isCompletion, boolean isNestedCompletion);
	 ...
	 */
	TNode createInjection(String sort, IToken leftToken, IToken rightToken, List<TNode> children, boolean isCompletion, boolean isNestedCompletion, boolean isBracket);
