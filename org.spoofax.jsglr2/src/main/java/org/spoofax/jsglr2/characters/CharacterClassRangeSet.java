...
public final class CharacterClassRangeSet implements ICharacters {
    ...
    protected final CharacterClassRangeSet update(Consumer<RangeSet<Integer>> transformer) {
    ...
    private static final BitSet convertToBitSet(final RangeSet<Integer> rangeSet) {
        ...
        rangeSet.asRanges().forEach(range -> bitSet.set(range.lowerEndpoint(), range.upperEndpoint() + 1));
