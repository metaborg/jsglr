...
java -jar target/org.spoofax.jsglr2.benchmark.jar -wi $1 -i $2 -f 1 -rff $3/benchmarks/jsglr2/java.csv "JSGLR2Java8Benchmark"
java -jar target/org.spoofax.jsglr2.benchmark.jar -wi $1 -i $2 -f 1 -rff $3/benchmarks/jsglr2/javaUnrolled.csv "JSGLR2Java8UnrolledBenchmark"
java -jar target/org.spoofax.jsglr2.benchmark.jar -wi $1 -i $2 -f 1 -rff $3/benchmarks/jsglr2/greenmarl.csv "JSGLR2GreenMarlBenchmark"
