...
public class InlinedEagerIncrementalInputStackTest extends AbstractIncrementalInputStackTest {
    ...
    protected IIncrementalInputStack getStack(IncrementalParseNode previousResult, String inputString,
        EditorUpdate... editorUpdates) {
        return new InlinedEagerIncrementalInputStack(previousResult, inputString, Arrays.asList(editorUpdates));
    }
