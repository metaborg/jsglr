...
public abstract class AbstractElkhoundStackManager<StackNode extends AbstractElkhoundStackNode<ParseForest>, ParseForest extends AbstractParseForest>
    extends StackManager<AbstractElkhoundStackNode<ParseForest>, ParseForest> {
    ...
    public DeterministicStackPath<AbstractElkhoundStackNode<ParseForest>, ParseForest> findDeterministicPathOfLength(
        ...
        return new DeterministicStackPath<AbstractElkhoundStackNode<ParseForest>, ParseForest>(parseForests,
            lastStackNode);
    }
