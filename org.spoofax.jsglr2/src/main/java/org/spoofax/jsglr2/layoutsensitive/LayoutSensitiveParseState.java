...
public class LayoutSensitiveParseState<StackNode extends IStackNode>
    extends AbstractParseState<LayoutSensitiveInputStack, StackNode> {

    private LayoutSensitiveParseState(LayoutSensitiveInputStack inputStack, IActiveStacks<StackNode> activeStacks,
...
//@formatter:on
    ParseStateFactory<ParseForest_, Derivation_, ParseNode_, StackNode_, LayoutSensitiveInputStack, ParseState_>
        ...
        return (inputStack, observing) -> {
            ...
            return (ParseState_) new LayoutSensitiveParseState<>(inputStack, activeStacks, forActorStacks);
        };
    }
