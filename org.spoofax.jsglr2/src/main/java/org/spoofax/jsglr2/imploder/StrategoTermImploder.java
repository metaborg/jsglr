...
public abstract class StrategoTermImploder<ParseForest extends AbstractParseForest, ParseNode extends ParseForest, Derivation extends IDerivation<ParseForest>> extends TokenizedTreeImploder<ParseForest, ParseNode, Derivation, IStrategoTerm> {
