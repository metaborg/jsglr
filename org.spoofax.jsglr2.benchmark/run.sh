...
java -jar target/org.spoofax.jsglr2.benchmark.jar -wi $1 -i $2 -f 1 -p implode=false -rff $3/benchmarks/jsglr1/java8_unrolled.csv "JSGLR1Java8UnrolledBenchmark"
...
java -jar target/org.spoofax.jsglr2.benchmark.jar -wi $1 -i $2 -f 1 -p implode=false -rff $3/benchmarks/jsglr2/java8_unrolled.csv "JSGLR2Java8UnrolledBenchmark"
