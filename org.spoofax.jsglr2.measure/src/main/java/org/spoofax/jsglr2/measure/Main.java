...
public class Main {
    ...
    public static void main(String[] args) throws ParseTableReadException, IOException, ParseException {
        ...
        for(TestSet testSet : TestSet.all) {
            ...
            JSGLR2Variants.Variant variantOptimzedParseForest =
                new JSGLR2Variants.Variant(ParseForestRepresentation.Hybrid, ParseForestConstruction.Optimized,
                    StackRepresentation.BasicElkhound, Reducing.Elkhound);
    ...
    private static void measure(TestSet testSet, JSGLR2Variants.Variant variant, String postfix)
    ...
    private static void csvRow(PrintWriter out, TestSetReader.InputBatch inputBatch,
