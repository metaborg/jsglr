...
public class IntegrationVariant {
    ...
    public static List<IntegrationVariant> testVariants() {
        ...
        return Arrays.asList(
            ...
            new IntegrationVariant(new ParseTableVariant(ActionsForCharacterRepresentation.Separated,      ProductionToGotoRepresentation.ForLoop),     new ParserVariant(ActiveStacksRepresentation.LinkedHashMap, ForActorStacksRepresentation.LinkedHashMap, ParseForestRepresentation.Hybrid, ParseForestConstruction.Full, StackRepresentation.HybridElkhound, Reducing.Elkhound, false), ImploderVariant.TokenizedRecursive,   TokenizerVariant.Null),/*
