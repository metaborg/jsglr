...
public class ParseFailureMessagesTest extends BaseTestWithSdf3ParseTables {
    ...
    @TestFactory public Stream<DynamicTest> wrongStartSymbolA() throws ParseError {
        ...
        //@formatter:off
            new MessageDescriptor(ParseFailureType.InvalidStartSymbol.message, Severity.ERROR)
        //@formatter:on
        ), "A");
    }
    ...
    @TestFactory public Stream<DynamicTest> unexpectedInputoffset0() throws ParseError {
        ...
        //@formatter:off
            new MessageDescriptor(ParseFailureType.UnexpectedInput.message, Severity.ERROR, 0, 1, 1)
        //@formatter:on
        ));
    }
    ...
    @TestFactory public Stream<DynamicTest> unexpectedInputoffset1() throws ParseError {
        ...
        //@formatter:off
            new MessageDescriptor(ParseFailureType.UnexpectedInput.message, Severity.ERROR, 1, 1, 2)
        //@formatter:on
        ));
    }
    ...
    @TestFactory public Stream<DynamicTest> unexpectedInputoffset2() throws ParseError {
        ...
        //@formatter:off
            new MessageDescriptor(ParseFailureType.UnexpectedInput.message, Severity.ERROR, 2, 1, 3)
        //@formatter:on
        ));
    }
    ...
    @TestFactory public Stream<DynamicTest> unexpectedEOFempty() throws ParseError {
        ...
        //@formatter:off
            new MessageDescriptor(ParseFailureType.UnexpectedEOF.message, Severity.ERROR, 0, 1, 1)
        //@formatter:on
        ));
    }
    ...
    @TestFactory public Stream<DynamicTest> unexpectedEOFx() throws ParseError {
        ...
        //@formatter:off
            new MessageDescriptor(ParseFailureType.UnexpectedEOF.message, Severity.ERROR, 1, 1, 2)
        //@formatter:on
        ));
    }
    ...
    @TestFactory public Stream<DynamicTest> unexpectedEOFxx() throws ParseError {
        ...
        //@formatter:off
            new MessageDescriptor(ParseFailureType.UnexpectedEOF.message, Severity.ERROR, 2, 1, 3)
        //@formatter:on
        ));
    }
