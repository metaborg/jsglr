...
public final class ByteOrder {
     ...
     * @since Android 1.0
     */
    public static final ByteOrder BIG_ENDIAN = new ByteOrder("BIG_ENDIAN"); //dNON-NLS-1d
     ...
     * @since Android 1.0
     */
    public static final ByteOrder LITTLE_ENDIAN = new ByteOrder("LITTLE_ENDIAN"); //dNON-NLS-1d
