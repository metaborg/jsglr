...
import com.totsp.compatibility.client.StringToByteBuffer;
...
public abstract class ByteBuffer extends Buffer implements Comparable<ByteBuffer>, StringToByteBuffer {
    ...
    public String toString() {
        ...
        buf.append(", status: capacity="); //dNON-NLS-1d
        buf.append(capacity());
        buf.append(" position="); //dNON-NLS-1d
        buf.append(position());
        buf.append(" limit="); //dNON-NLS-1d
        buf.append(limit());
        return buf.toString();
    }
