...
//@formatter:off
   <ParseForest extends IParseForest,
    ParseState  extends IParseState<ParseForest, BasicElkhoundStackNode<ParseForest>>,
    Parse       extends AbstractParse<ParseForest, BasicElkhoundStackNode<ParseForest>, ParseState>>
//@formatter:on
    extends ElkhoundStackManager<ParseForest, BasicElkhoundStackNode<ParseForest>, ParseState, Parse> {
