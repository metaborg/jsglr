...
public class IntegrationVariant {
    ...
    public static List<IntegrationVariant> testVariants() {
        ...
        return Arrays.asList(
            ...
            new IntegrationVariant(new ParseTableVariant(ActionsForCharacterRepresentation.Separated,      ProductionToGotoRepresentation.ForLoop),     new ParserVariant(ActiveStacksRepresentation.LinkedHashMap, ForActorStacksRepresentation.LinkedHashMap, ParseForestRepresentation.Incremental, ParseForestConstruction.Full, StackRepresentation.Hybrid,    Reducing.Incremental), ImploderVariant.RecursiveIncremental, TokenizerVariant.Recursive),
